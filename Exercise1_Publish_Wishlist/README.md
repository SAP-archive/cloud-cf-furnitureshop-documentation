- - - -
Previous Exercise: [Setup](../Setup) Next Exercise: [Exercise 2 - Order New Items](../Exercise2_Order_New_Items)
...
![Project Template](images/Business_Application_Template1.jpg)
...
## 3. Create WishlistHandler.java to implement update method to the collection Wishlist
In the next exercises we will capture ratings of the products from colleagues of Frank. So we will add the required coding to capture the product ratings.

1.	Under the `srv` module, navigate to src - main - java - com - company - furnitureshop and right-click and choose _Create new Java Class_ enter the class name as `WishlistHandler` (do not add .java extension, WebIDE will add it automatically).
...
This completes the development of the wishlist application which Frank will use to view the wishlist of furniture that could be added to the current range.
- - - -
© 2018 SAP SE
- - - -
Previous Exercise: [Setup](../Setup) Next Exercise: [Exercise 2 - Order New Items](../Exercise2_Order_New_Items)
